...
MUTATION_RATE = 0.1
class Data:
    ROOMS = [["D507а",25], ["D232",45], ["D229",35]]
    MEETING_TIMES = [["PN1", "18:00 - 19:30"],
                     ["PN2", "18:00 - 19:30"],
                     ["VT1", "18:00 - 19:30"],
                     ["VT2", "18:00 - 19:30"]]
    INSTRUCTORS = [["P1", "Nuriev Na Ksh"],
                   ["P2", "Pecheniy Yev Abr"],
                   ["P3", "Ahmetshin Di Agz"],
                   ["P4", "Nabiev Ra Rin"], 
                   ["P5", "Starygina Sv Dm"], 
    ...
    def __init__(self):
        ...
        course1 = Course("C1", "ASIS", [self._instructors[2], self._instructors[3]], 25)
        course2 = Course("C2", "MPIS", [self._instructors[0], self._instructors[4]],  35)
        course3 = Course("C3", "SI", [self._instructors[5]],  25)
        course4 = Course("C4", "SAPIS", [self._instructors[2], self._instructors[3]], 30)
        course5 = Course("C5", "IMM", [self._instructors[1]], 35)
        course6 = Course("C6", "FIL", [self._instructors[7]], 45)
        course7 = Course("C7", "SM", [self._instructors[6]], 45)
        course8 = Course("C8", "ENG", [self._instructors[8]], 45)
        self._courses = [course1, course2, course3, course4, course5, course6, course7, course8]
        dept1 = Department("FIN", [course6])
        dept2 = Department("IPM", [course1, course2, course3, course4, course5, course7])
        dept3 = Department("IYAPK", [course8])
